      ...
      <form onSubmit={this.handleSubmit}>
        <div style={styles.container}>
          <div style={styles.column}>
            ...
            <select style={styles.select} onChange={this.handleChangeMedName}>
              <option>Choose from ...</option>
              <option
                medId='1'
                selected={medName === 'Paracetamol' ? 'selected' : ''}
                value='Paracetamol'
              >
                Paracetamol
              </option>
              <option
                medId='2'
                selected={medName === 'Ibuprofen' ? 'selected' : ''}
                value='Ibuprofen'
              >
                Ibuprofen
              </option>
              <option
                medId='3'
                selected={medName === 'Warfarin' ? 'selected' : ''}
                value='Warfarin'
              >
                Warfarin
              </option>
              ...
              <option
                medId='5'
                selected={medName === 'Codeine' ? 'selected' : ''}
                value='Codeine'
              >
                Codeine
              </option>
              <option
                medId='6'
                selected={medName === 'Amoxicillin' ? 'selected' : ''}
                value='Amoxicillin'
              >
                Amoxicillin
              </option>
              <option
                medId='7'
                selected={medName === 'Diazepan' ? 'selected' : ''}
                value='Diazepan'
              >
                Diazepan
              </option>
              <option
                medId='8'
                selected={medName === 'Zopiclone' ? 'selected' : ''}
                value='Zopiclone'
              >
                Zopiclone
              </option>
              <option
                medId='9'
                selected={medName === 'Nitrofurantoin' ? 'selected' : ''}
              ...
              <option
                medId='10'
                selected={medName === 'Pravastatin' ? 'selected' : ''}
                value='Pravastatin'
              >
                Pravastatin
              </option>
          ...
          <div style={styles.column}>
            ...
            <select style={styles.select} onChange={this.handleChangeFrequency}>
              <option>Choose from ...</option>
              <option
                selected={frequency === 'Once' ? 'selected' : ''}
                value='Once'
                index='1'
              >
                Once
              ...
              <option
                selected={frequency === 'Twice' ? 'selected' : ''}
                value='Twice'
                index='2'
              >
                Twice
              ...
              <option
                selected={frequency === 'Three Times' ? 'selected' : ''}
                value='Three Times'
                index='3'
              >
                Three Times
          ...
          <div style={styles.column}>
            ...
            <select style={styles.select} onChange={this.handleChangeUnit}>
              <option>Choose from ...</option>
              <option
                selected={unit === '500mg tablet' ? 'selected' : ''}
                value='500mg tablet'
              >
                500mg tablet
              </option>
              <option
                selected={unit === '200mg tablet' ? 'selected' : ''}
                value='200mg tablet'
              >
                200mg tablet
              </option>
